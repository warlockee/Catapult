...
class HiggsAudioEncoderConfig(PretrainedConfig):
    """Configuration of the Audio encoder."""
...
class HiggsAudioConfig(PretrainedConfig):
    r"""
    This is the configuration class for the AudioModel.
    ...
    Args:
        ...
        audio_bos_token (`str`, *optional*, defaults to "<|audio_bos|>"):
            The special `<|audio_bos|>` token. Mapped to 128011,
...
class HiggsAudio3Config(HiggsAudioConfig):
    # higgs_audio_3 config is the same as higgs_audio config, just with a different model type
